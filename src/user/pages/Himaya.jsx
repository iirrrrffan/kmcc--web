...
const Himaya = () => {
  return (
    <div>
    <HeadOne/>
    <section className="py-16 bg-gradient-to-b text-white">
    <UNav/>
      <div className="container mx-auto px-6 sm:px-8 lg:px-16">
        ...
        {/* Vision */}
        <div className="mb-12">
          <h2 className="text-3xl font-semibold text-green-600 mb-4">The Vision Behind Himaya Thuqba</h2>
        ...
        {/* Key Features */}
        <div className="mb-12">
          <h2 className="text-3xl font-semibold text-green-600 mb-4">Key Features of KMCC Himaya Thuqba</h2>
          <ul className="space-y-6">
            <li>
              <h3 className="text-xl font-semibold text-green-600">Membership Benefits</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <li>
              <h3 className="text-xl font-semibold text-green-600">Medical Assistance</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <li>
              <h3 className="text-xl font-semibold text-green-600">Legal Support</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <li>
              <h3 className="text-xl font-semibold text-green-600">Repatriation Services</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <li>
              <h3 className="text-xl font-semibold text-green-600">Educational Support</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <li>
              <h3 className="text-xl font-semibold text-green-600">Community Development</h3>
              <p className="text-gray-600 leading-relaxed">
        ...
        {/* Importance */}
        <div className="mb-12">
          <h2 className="text-3xl font-semibold text-green-700 mb-4">Why Himaya Thuqba is Important for the Community</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        {/* Impact */}
        <div className="mb-12">
          <h2 className="text-3xl font-semibold text-green-700 mb-4">The Impact of Himaya Thuqba</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        {/* Conclusion */}
        <div>
          <h2 className="text-3xl font-semibold text-green-700 mb-4">A Testament to KMCC’s Commitment</h2>
          <p className="text-gray-600 leading-relaxed">
