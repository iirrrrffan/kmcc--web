...
const KmccScheme = () => {
  return (
    <div className="min-h-screen bg-white p-8 flex flex-col items-center justify-center space-y-10">
      {/* Header */}
      <h1 className="text-4xl font-extrabold text-black text-center animate-fade-in-down">
        KMCC Scheme
      </h1>

      {/* Flex container to display sections horizontally on larger screens */}
      <div className="flex flex-wrap space-x-10 w-full max-w-screen-xl justify-center gap-10">
